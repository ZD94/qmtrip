...
var staff_1 = require("api/_types/staff/staff");
var travelPolicy_1 = require("api/_types/travelPolicy");
var subsidy_templates_1 = require("./subsidy-templates");
var msgbox = require('msgbox');
function EditpolicyController($scope, Models, $stateParams, $ionicHistory, $ionicPopup, ngModalDlg) {
            ...
            switch (_b.label) {
                ...
                case 5:
                    ...
                    $scope.savePolicy = function () {
                        return __awaiter(this, void 0, void 0, function () {
                            var re, travelPolicy, err_1, _i, saveSubsidyTemplates_1, v, _a, removeSubsidyTemplates_1, v;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
