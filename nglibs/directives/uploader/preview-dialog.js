...
function showPreviewDialog($scope, ngModalDlg, options) {
...
exports.showPreviewDialog = showPreviewDialog;
function canvas2Blob(canvas) {
    var toBlob = $(canvas).data('toBlob');
    if (toBlob)
        return toBlob();
...
function previewImageController($scope, $element) {
