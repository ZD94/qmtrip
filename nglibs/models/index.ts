...
var Services = {
    ...
    tripDetailInvoice: { type: TripDetailInvoice, modname: 'tripPlan', funcs: ['getTripDetailInvoice', 'getTripDetailInvoices', 'saveTripDetailInvoice', 'saveTripDetailInvoice', 'deleteTripDetailInvoice']},
