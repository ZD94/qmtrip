...
import { Staff, Credential, PointChange, InvitedLink, StaffSupplierInfo, StaffProperty, Linkman, Feedback, IdentityInfo} from '_types/staff';
...
initModels({
    ...
    identityInfo: createServerService<IdentityInfo>(IdentityInfo),
