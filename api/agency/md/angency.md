...
>. 创建代理商用户 API.agency.createAgencyUser(params);
...
>. 删除代理商用户 API.agency.deleteAgencyUser(agencyUserId);
...
>. 修改代理商用户信息 API.agency.updateAgencyUser(params);
...
>. 查询代理商用户信息 API.agency.getAgencyUser(agencyUserId);
...
>. 查询当前代理商用户 API.agency.getCurrentAgencyUser();
...
>. 更新代理商 API.agency.updateAgency(agency);
...
>. 获取代理商信息 API.agency.getAgencyById(agency);
...
>. 删除代理商 API.agency.deleteAgency(params);
