...
let {Agency: AgencyModel, AgencyUser: AgencyUserModel} = sequelize.models;
...
let agencyCols = Object.keys(AgencyModel.attributes);
let agencyUserCols = Object.keys(AgencyUserModel.attributes);
