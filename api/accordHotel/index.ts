...
class AccordHotelModule{
    ...
    static async createAccordHotel (params: any) : Promise<AccordHotel>{
    ...
    static async deleteAccordHotel(params: any) : Promise<any>{
        var id = params.id;
    ...
    static async updateAccordHotel(params: any) : Promise<AccordHotel>{
        var id = params.id;
    ...
    static async getAccordHotels(params: any): Promise<FindResult>{
        var staff = await Staff.getCurrent();
