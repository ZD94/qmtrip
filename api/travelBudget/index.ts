    ...
    static async getHotelsData(params: ISearchHotelParams): Promise<any> {
        ...
        if (config.tmcFake == 1) {
            ...
            if (meiyaHotel){
                ...
                commonData = combineData(commonData, 'cnName', 'agents');
                return commonData;
            }else { 
                return []
            }            
    ...
    static async getTrafficsData(params: ISearchTicketParams): Promise<any> {
        ...
        if (config.tmcFake == 1) {
            ...
            if (meiyaFlight) {
                ...
                commonData = combineData(commonData, 'flightNo', 'agents')
            }    
            if (meiyaTrain){      
                commonData2 = handleTrainData(meiyaTrain, params)
                commonData2 = combineData(commonData2, 'TrainNumber', 'agents')
            }        
