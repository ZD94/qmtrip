...
class ApiStaff {
     ...
     * @returns {*|Promise}
     */
    static createPapers(params): Promise<Credentials>{
     ...
     * @returns {*|Promise}
     */
    static updatePapers (params): Promise<Credentials>{
        var user_id = this["accountId"];
     ...
     * @returns {*|Promise}
     */
    static getPapersById(params): Promise<Credentials>{
        var id = params.id;
        var user_id = this["accountId"];
     ...
     * @returns {*|Promise}
     */
    static getOnesPapersByType(params): Promise<Credentials>{
        var user_id = this["accountId"];
        params.ownerId = user_id;
     ...
     * @returns {*|Promise}
     */
    static getCurrentUserPapers(): Promise<Credentials[]>{
        var user_id = this["accountId"];
