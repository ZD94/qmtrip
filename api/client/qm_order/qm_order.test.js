...
describe("api/client/qm_order.js", function() {
    ...
    it("#create_qm_order should be ok", function(done) {
        var self = {
            user_id: '000000001111-0000-0000-0000-00000000'
        }

        var params = {
            consumeId: '000000001111-0000-0000-0000-00000000',
            passengers: [],
            bookId: 'airticket:bid_14601982889829CsA'
        };
        return API.client.qm_order.create_qm_order.apply(self, params)
