...
import {EPlanStatus, TripPlan, Project, TripDetail} from 'api/_types/tripPlan';
...
class ApiTripPlan {
     ...
     */
    static saveConsumeDetail(params) {
        let self: any = this;
        params.accountId = self.accountId;
        return API.tripPlan.saveTripDetail(params);
    }
     ...
     */
    @requireParams(['id'])
    static async getTripPlan(params:{id:string}) {
        let self: any = this;
     ...
     */
    @requireParams([], ['page', 'perPage', 'startTime', 'endTime', 'order', 'startAt', 'backAt', 'deptCity',
        'arrivalCity', 'isNeedTraffic', 'isNeedHotel', 'budget', 'expenditure', 'remark'])
    static async pageCompleteTripPlans(params) {
        let self: any = this;
        let accountId = self.accountId;
    ...
    static pageTripPlansByCompany(params) {
        let self: any = this;
        let accountId = self.accountId;
     ...
     */
    @requireParams(['id'])
    static deleteConsumeDetail(params:{id:string}) {
        let self: any = this;
        params['userId'] = self.accountId;
     ...
     * @returns {Promise<boolean>}
     */
    @requireParams(['consumeId', 'picture'])
    static uploadInvoice(params:{consumeId:string, picture:string}) {
        let self: any = this;
        params['userId'] = self.accountId;
     ...
     * @returns {Promise<any>}
     */
    static getConsumeInvoiceImg(params:{consumeId:string}) {
     ...
     * @param params
     */
    @requireParams(['statTime'])
    static async statStaffsByCity(params:{statTime:string}) {
        let self: any = this;
     ...
     */
    @requireParams([], ['count', 'project_name'])
    static async getProjectsList(params:{count?:number, project_name?:string}) {
        let self: any = this;
     ...
     * @returns {Promise<boolean>}
     */
    @requireParams(['id', 'budget'], ['remark'])
    static async editTripPlanBudget(params):Promise<boolean> {
        let self: any = this;
        let accountId = self.accountId;
